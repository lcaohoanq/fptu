package com.orchid.s1orchidservice.configs;

import com.orchid.s1orchidservice.filters.JwtTokenFilter;
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(
                    ...
                    //GET /orchids/**
                    //
                .requestMatchers("GET", String.format("%s/orchids/**", apiPrefix)).permitAll()
