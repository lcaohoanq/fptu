import {
  ...
  useWaitForDOMRef
} from "./chunk-PFN3JCT5.js";
import {
  Container_default
} from "./chunk-LZD244S3.js";
import {
  CardHeaderContext_default,
  NavItem_default,
  Nav_default,
  Nav_default2
} from "./chunk-VLPFVCGX.js";
import {
  useMergedRefs_default as useMergedRefs_default2
} from "./chunk-YIU74WAA.js";
import {
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-BU3GQHTM.js";
import {
  Table_default
} from "./chunk-QQ7EPHI6.js";
import {
  require_react_dom
} from "./chunk-NXESFFTV.js";
import {
  Badge_default
} from "./chunk-DUGA7JMH.js";
import {
  Button_default
} from "./chunk-CJHD3ZK2.js";
import "./chunk-4R6N6V7S.js";
import {
  DEFAULT_BREAKPOINTS,
...
var BreadcrumbItem = React12.forwardRef(({
  ...
  return (0, import_jsx_runtime11.jsx)(Component2, {
    ...
    children: active ? children : (0, import_jsx_runtime11.jsx)(LinkComponent, {
      ...linkProps,
      href,
      title,
      target,
...
var Breadcrumb = React13.forwardRef(({
  ...
  return (0, import_jsx_runtime12.jsx)(Component2, {
    ...
    ref,
    ...props,
    children: (0, import_jsx_runtime12.jsx)("ol", {
      ...listProps,
...
var FigureImage = React34.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React35.forwardRef(({
  className,
  bsPrefix,
...
var Feedback = React37.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
    ...
    ...props,
    ref,
    className: (0, import_classnames33.default)(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
  })
);
...
var FormCheckInput = React39.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
  ...
  return (0, import_jsx_runtime39.jsx)(Component2, {
    ...
    type,
    id: id || controlId,
    className: (0, import_classnames34.default)(className, bsPrefix, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormCheckLabel = React40.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
  ...
  return (0, import_jsx_runtime40.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React41.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const innerFormContext = (0, import_react15.useMemo)(() => ({
    controlId: id || controlId
  }), [controlId, id]);
  const hasLabel = !children && label != null && label !== false || hasChildOfType(children, FormCheckLabel_default);
  const input = (0, import_jsx_runtime41.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime41.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime41.jsx)("div", {
      style,
      className: (0, import_classnames36.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
      children: children || (0, import_jsx_runtime43.jsxs)(import_jsx_runtime42.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime41.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime41.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormControl = React42.forwardRef(({
  bsPrefix,
  type,
  size: size2,
  htmlSize,
  ...
  return (0, import_jsx_runtime44.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames37.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size2 && `${bsPrefix}-${size2}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormFloating = React43.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React44.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormLabel = React45.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "label",
  bsPrefix,
  column = false,
  ...
  const classes = (0, import_classnames39.default)(className, bsPrefix, visuallyHidden && "visually-hidden", column && columnClass);
  true ? (0, import_warning2.default)(controlId == null || !htmlFor, "`controlId` is ignored on `<FormLabel>` when `htmlFor` is specified.") : void 0;
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime47.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime47.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var FormRange = React46.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
  ...
  const {
    controlId
  } = (0, import_react19.useContext)(FormContext_default);
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-range");
  return (0, import_jsx_runtime48.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React47.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime49.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
    className: (0, import_classnames41.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React48.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
    ...
    return (0, import_jsx_runtime50.jsx)(Component2, {
      ...props,
      ref,
      className: (0, import_classnames42.default)(className, bsPrefix, muted && "text-muted")
    });
  }
);
...
var Switch = React49.forwardRef((props, ref) => (0, import_jsx_runtime51.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React50.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-floating");
  return (0, import_jsx_runtime53.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames43.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime52.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Form = React51.forwardRef(({
  ...
  as: Component2 = "form",
  ...props
}, ref) => (0, import_jsx_runtime54.jsx)(Component2, {
  ...props,
  ref,
  className: (0, import_classnames44.default)(className, validated && "was-validated")
}));
...
var InputGroupText = React52.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime56.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime56.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime56.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime56.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
});
var InputGroup = React53.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
  ...
  return (0, import_jsx_runtime56.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime56.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames46.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
var ListGroupItem = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)(Component2, {
    ...
    ...navItemProps,
    onClick: handleClick,
    className: (0, import_classnames47.default)(className, bsPrefix, meta.isActive && "active", disabled && "disabled", variant && `${bsPrefix}-${variant}`, action && `${bsPrefix}-action`)
  });
});
...
var ListGroup = React55.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime58.jsx)(Nav_default, {
    ...
    ...controlledProps,
    as,
    className: (0, import_classnames48.default)(className, bsPrefix, variant && `${bsPrefix}-${variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, numbered && `${bsPrefix}-numbered`)
  });
});
...
function useCallbackRef2() {
  return (0, import_react22.useState)(null);
}
...
var ModalDialog = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime60.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames50.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime60.jsx)("div", {
      className: (0, import_classnames50.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
var ModalHeader = React59.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var ModalTitle = React60.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime64.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal = React61.forwardRef(({
  ...
  const renderBackdrop = (0, import_react23.useCallback)((backdropProps) => (0, import_jsx_runtime64.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames54.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime64.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    style: baseModalStyle,
    className: (0, import_classnames54.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime64.jsx)(Dialog, {
      ...props,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React62.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var PopoverHeader = React63.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React64.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React66.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime68.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime67.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime67.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React67.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Overlay2 = React68.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime71.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React68.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React69.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime74.jsxs)(import_jsx_runtime73.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react28.cloneElement)(children, triggerProps), (0, import_jsx_runtime72.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React70.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime75.jsx)("li", {
    ...
    children: (0, import_jsx_runtime76.jsxs)(Component2, {
      className: (0, import_classnames60.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime75.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React70.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime76.jsxs)(PageItem, {
    ...props,
    ref,
    children: [(0, import_jsx_runtime75.jsx)("span", {
      "aria-hidden": "true",
      children: children || defaultValue
    }), (0, import_jsx_runtime75.jsx)("span", {
      className: "visually-hidden",
      children: label
    })]
  }));
...
var Pagination = React71.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime77.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React72.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime78.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React73.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime80.jsx)("div", {
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime80.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React74.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React75.forwardRef(({
  ...
  return (0, import_jsx_runtime81.jsx)("div", {
    ...
    children: React75.Children.only(children)
  });
});
...
var Spinner = React77.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React78.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime85.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime84.jsx)(Button_default, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime84.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime84.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var TabPanel = React80.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime87.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime87.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime87.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime87.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime89.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React83.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React84.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime91.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime91.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime91.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime91.jsx)(Component2, {
          ...rest,
          ref,
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime92.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime92.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime93.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime92.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime92.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime92.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React86.forwardRef((props, ref) => (0, import_jsx_runtime94.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React88.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context3 = (0, import_react32.useContext)(ToastContext_default);
  ...
  return (0, import_jsx_runtime96.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime95.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React89.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React90.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime98.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime98.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime98.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React91.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop2 = () => void 0;
var ToggleButton = React92.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime102.jsxs)(import_jsx_runtime101.Fragment, {
    children: [(0, import_jsx_runtime100.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime100.jsx)(Button_default, {
      ...props,
      ref,
...
var ToggleButtonGroup = React93.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime103.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
