...
public class UserDAO {
    ...
    private static final String SEARCH = "SELECT userID, fullName FROM tblUsers WHERE fullName like ?";
    private static final String DELETE = "DELETE tblUsers WHERE userID=?";
    private static final String UPDATE = "UPDATE tblUsers SET fullName=? WHERE userID=?";
    private static final String CHECK_DUPLICATE = "SELECT userID FROM tblUsers WHERE userID=?  ";
    private static final String INSERT = "INSERT INTO tblUsers(userId, fullName, password) "
            + "                         VALUES(?,?,?)";
